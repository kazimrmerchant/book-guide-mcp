...
- **Launch kit** (Product Hunt copy, directory checklist): [marketing/LAUNCH_KIT.md](marketing/LAUNCH_KIT.md)
- **MCP Registry manifest** (after PyPI publish): [marketing/server.json](marketing/server.json)
